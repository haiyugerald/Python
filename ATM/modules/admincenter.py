...
# print(__db_creditcard_dict,__db_users_dict)
                    ...
                    if creditcard.isdigit() and len(creditcard) == 6:
                        ...
                        if len(password.strip()) > 0:
                            ...
                            if len(personinfo.strip()) > 0:
                                creditcard_dict[creditcard] = {"creditcard": creditcard, "password": password,
                                                               "personinfo": personinfo,
                                                               "limit": limit, "limitcash": limit // 2,
                                                               "locked": locked, "deflimit": limit}
    ...
    while True:
        ...
        with open(__db_creditcard_dict, "r+") as f_creditcard_dict:
            ...
            if if_Updata == "y":
                ...
                if creditcard in creditcard_dict.keys():
                    limit = input("\33[34;0m输入额度修改后的金额(至少￥15000)\33[0m:")
                    if limit.isdigit():
