...
def acc_login(user_data,log_obj):
    ...
    while user_data['is_authenticated'] is not True and retry_count < 3 :
        account = input("\033[32;1m Please input your account:\033[0m").strip()
        password = input("\033[32;1m Please input your password:\033[0m").strip()
        auth = acc_auth2(account, password)   #调用优化版认证接口
